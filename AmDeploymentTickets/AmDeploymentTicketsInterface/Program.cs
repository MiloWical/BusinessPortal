...
namespace AmDeploymentTicketsInterface
{
    public class Program
    {
        ...
        {
            ServiceRuntime.RegisterServiceAsync("AmDeploymentTicketsInterface", context => new WebHostingService(context, "ServiceEndpoint")).GetAwaiter().GetResult();
